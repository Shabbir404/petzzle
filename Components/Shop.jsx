            ...
            <div className="md:mt-30 mt-16">
                ...
                <div className="w-11/12 md:w-10/12 mx-auto">
                    <div className="relative lg:w-3/12">
                        ...
                        <button
                            className="md:hidden flex items-center px-4 py-2 bg-blue-500 text-white rounded mb-4"
                        ...
                        <div className={`bg-white p-4 rounded  ${isOpen ? 'block' : 'hidden'} md:block`}>
                            ...
                            <div className="mb-6 border p-5 border-[#E5E5E5] rounded-md">
                                <h3 className="font-bold text-gray-800 mb-2">Filter By Categories</h3>
                            ...
                            {/* Highlight */}
                            <div className="mb-6 border p-5 border-[#E5E5E5] rounded-md">
                                <h3 className="font-bold text-gray-800 mb-2">Highlight</h3>
                                <ul className="space-y-1">
                            ...
                            {/* Filter By Color */}
                            <div className="mb-6 border p-5 border-[#E5E5E5] rounded-md">
                                <h3 className="font-bold text-gray-800 mb-2">Filter By Color</h3>
